          ...
          <div className="font-poppins text-[16px] leading-[26px] text-white mb-6 max-w-[516px] w-full">
            <form className="sm:flex">
              ...
              <div className="mt-3 sm:mt-0 sm:ml-3 sm:flex-shrink-0 rounded-md shadow">
                <Link
                  href="/"
                  className="w-full flex items-center justify-center px-5 py-[10px] bg-[#4ACAC6] text-white text-[16px] leading-[28px] font-poppins font-semibold text-center rounded-[5px] hover:bg-[#3bbab0]"
                >
                  Sign Up
                </Link>
              </div>
