        ...
        <div className="w-full mx-auto grid grid-cols-1 gap-3 md:grid-cols-2 mb-12">
          <div className="relative rounded-xl overflow-hidden shadow-md">
            ...
            <div className="relative z-20 sm:py-20 py-8 px-8 text-white">
              <span className="inline-block bg-purple-200 text-purple-700 lg:text-lg font-semibold px-3 py-1 rounded-md mb-2">
                New
              </span>
              <h2 className="sm:text-2xl lg:text-3xl text-xl font-bold mb-4">
